(define (domain mintask)
  ...
  (:action completar-tarea-simple
    ...
    :effect (and (not (tSimple ?t)) (tRevisada ?t ?p) (increase (ttime) (+ (tiempo-tarea ?t) (calidad ?p))) (decrease (tareas-programador ?p) 1))
  )
  ...
  (:action completar-tarea-simple-con-suplemento
    ...
    :effect (and (not (tSimple ?t)) (tRevisada ?t ?p) (increase (ttime) (+ (+ (tiempo-tarea ?t) 2) (calidad ?p))) (decrease (tareas-programador ?p) 1))
  )
  ...
  (:action completar-tarea-revisada
    ...
    :effect (and (not (tRevisada ?t ?p2)) (finalizada ?t) (decrease (tareas-programador ?p1) 1))
  )
